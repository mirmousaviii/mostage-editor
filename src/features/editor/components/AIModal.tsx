          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-32 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white resize-none"
            ...
            <button
              ...
              className={`w-full text-white font-medium py-3 px-6 rounded-md transition-all duration-200 flex items-center justify-center gap-2 shadow-md bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 hover:shadow-xl`}
            >
              {isGenerating ? (
                <>
            ...
            {generatedContent && (
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md border border-gray-200 dark:border-gray-600 max-h-96 overflow-y-auto">
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-primary/90 text-primary-foreground py-2 px-4 rounded-md transition-colors flex items-center justify-center gap-2"
                  >
